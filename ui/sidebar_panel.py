# Model seçimi ve butonların olduğu panel
...
class SidebarPanel(ctk.CTkFrame):
    def __init__(self, master, start_callback, **kwargs):
        ...
        self.source_type = None # 'image', 'video' veya 'webcam'
        ...
        # Butonlar yan yana dursun diye küçük bir frame açıyoruz
        ...
        # state="readonly" parametresi eklendi
        ...
        self.model2_combo.pack(padx=20, pady=(5, 20), fill="x")
